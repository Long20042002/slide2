...
router.post('/profile',function (rep,res,){
    const file = rep.file;
    upload(rep, res, function (err)
    {
        if (!file) {
            res.render('about', {message: err.message})
        } else {
            res.render('about', {message: 'Thành Công!!!'})
        }
    })
})
...
router.get('/hot',function (req,res) {
    ...
    var sinhVien = {name: 'Long Nguyen', sinhNhat: '0394938443', sdt: '034234230432'}

    var danhSach = [{name: 'Long Nguyen 1', sinhNhat: '394392992', sdt: '099334343'},
        {name: 'Long Nguyen 2', sinhNhat: '394392992', sdt: '099334343'},
        {name: 'Long Nguyen 3', sinhNhat: '394392992', sdt: '099334343'},
        {name: 'Long Nguyen 4', sinhNhat: '394392992', sdt: '099334343'},
        {name: 'Long Nguyen 5', sinhNhat: '394392992', sdt: '099334343'}]

    var thongTin = {
        name: 'Long Nguyen',
        favorite: 'Laptop',
        danhSachBaiGai: [
            {name: 'Long Nguyen 1', sinhNhat: '394392992', sdt: '099334343'},
            {name: 'Long Nguyen 2', sinhNhat: '394392992', sdt: '099334343'},
            {name: 'Long Nguyen 3', sinhNhat: '394392992', sdt: '099334343'},
            {name: 'Long Nguyen 4', sinhNhat: '394392992', sdt: '099334343'},
            {name: 'Long Nguyen 5', sinhNhat: '394392992', sdt: '099334343'}
...
router.post('/student',function (req,res) {
    ...
    // })
    //
    // Student.updateOne({_id}, {email: 'abc@gmail.com', name: 'aaaaaa'}, function (error){
    //
    // })
})
